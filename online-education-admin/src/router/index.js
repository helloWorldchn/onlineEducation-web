...
export const constantRoutes = [
  ...
  // 首页
  {
    ...
    children: [{
      ...
      meta: { title: '才华教育后台首页', icon: 'dashboard' }
    }]
  }]
/**
 * 动态路由
  ...
  // 讲师管理
  {
    ...
    children: [
      ...
      },
      {
        path: 'cate',   
        name: '文章类别',
        component: () => import('@/views/edu/article/cate'),
        meta: { title: '文章类别', noCache: true },
        hidden: true
      }
    ]
  },
